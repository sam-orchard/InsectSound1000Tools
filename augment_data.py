...
input_dir = '/Users/samorchard/Documents/InsectSound1000_training/test'
output_dir = '/Users/samorchard/Documents/InsectSound1000_training/augmented_test'
noise_directory = ''
...
for label in labels:
    ...
    for file in os.listdir(species_input_dir):
        sig, rate = librosa.load(file, sr=16000, mono=True, res_type='kaiser_fast')

        # TODO: Randomly select a channel from sig to be used as the augmented data
        ...
        augmented_data = augment_audio_file(sig, rate, noise_directory=noise_directory, min_absolute_rms_db=-45, max_absolute_rms_db=-17)
